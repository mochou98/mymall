...
import org.mochou.mymall.db.service.MymallKeywordService;
...
public class AdminKeywordController {
    ...
    public Object list(String keyword, String url,
        ...
        List<MymallKeyword> brandList = keywordService.querySelective(keyword, url, page, limit, sort, order);
    ...
    @PostMapping("/create")
    public Object create(@RequestBody MymallKeyword keywords) {
    ...
    public Object read(@NotNull Integer id) {
        MymallKeyword brand = keywordService.findById(id);
    ...
    @PostMapping("/update")
    public Object update(@RequestBody MymallKeyword keywords) {
        Object error = validate(keywords);
        if (error != null) {
            return error;
        }
