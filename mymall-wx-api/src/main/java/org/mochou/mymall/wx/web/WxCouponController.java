...
import org.mochou.mymall.wx.dao.CouponVo;
import org.mochou.mymall.wx.util.WxResponseCode;
...
public class WxCouponController {
    ...
    public Object list(@RequestParam(defaultValue = "1") Integer page,
        ...
        List<MymallCoupon> couponList = couponService.queryList(page, size, sort, order);
    ...
    public Object mylist(@LoginUser Integer userId,
        ...
        List<MymallCouponUser> couponUserList = couponUserService.queryList(userId, null, status, page, size, sort, order);
    ...
    public Object selectlist(@LoginUser Integer userId, Integer cartId, Integer grouponRulesId) {
        ...
        List<MymallCouponUser> availableCouponUserList = new ArrayList<>(couponUserList.size());
